      ...
      <div class="flex items-center gap-3 px-4 h-16 border-b border-midnight-600/30 shrink-0">
        ...
        <transition name="fade">
          <span
            ...
            class="font-heading text-lg text-strawberry-400 whitespace-nowrap overflow-hidden"
          >
            StrawSim V2
          </span>
        </transition>
...
/* V2 激活导航项 - 使用 strawberry 红色 */
.nav-item-active-v2 {
  @apply flex items-center gap-3 px-4 py-3 rounded-lg
         text-strawberry-400 bg-strawberry-500/10
         border-l-2 border-strawberry-500 cursor-pointer;
}
</style>
